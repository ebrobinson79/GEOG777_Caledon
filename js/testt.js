...
const apiKey = "7cd75e4b9cacaecbf8ff0218ba901a0a49e2d293";
...
function addPOIs(map,getURL,apiKey){
    ...
    var POIlayers = [];
       ...
       $.getJSON(getURL+'SELECT * FROM ebrobinson.parking&api_key='+apiKey, function(data){
        var features = data.features
        var parkingLot = L.geoJSON(features);
        POIlayers.push(parkingLot);
        parkingLot.addTo(map);
    })};
